...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ninja.allergies'
        db.alter_column(u'ninjas_ninja', 'allergies', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

    def backwards(self, orm):

        # Changing field 'Ninja.allergies'
        db.alter_column(u'ninjas_ninja', 'allergies', self.gf('django.db.models.fields.CharField')(default='', max_length=140))
