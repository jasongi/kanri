...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field jobs_desired on 'Mentor'
        m2m_table_name = db.shorten_name(u'mentors_mentor_jobs_desired')
        ...
        db.create_unique(m2m_table_name, ['mentor_id', 'job_id'])


    def backwards(self, orm):
        # Removing M2M table for field jobs_desired on 'Mentor'
        db.delete_table(db.shorten_name(u'mentors_mentor_jobs_desired'))
    ...
    models = {
        ...
        u'mentors.mentor': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jobs_desired': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['jobs.Job']", 'symmetrical': 'False'}),
