...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mentor.needs_shirt'
        db.add_column(u'mentors_mentor', 'needs_shirt',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mentor.needs_shirt'
        db.delete_column(u'mentors_mentor', 'needs_shirt')
