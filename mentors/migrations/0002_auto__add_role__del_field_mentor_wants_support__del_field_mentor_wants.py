...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Mentor.wants_support'
        db.delete_column(u'mentors_mentor', 'wants_support')

        # Deleting field 'Mentor.wants_champion'
        db.delete_column(u'mentors_mentor', 'wants_champion')

        # Deleting field 'Mentor.wants_lead'
        db.delete_column(u'mentors_mentor', 'wants_lead')

        # Adding field 'Mentor.curtin_status'
        db.add_column(u'mentors_mentor', 'curtin_status',
                      self.gf('django.db.models.fields.TextField')(default='N', max_length=1),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Mentor.wants_support'
        db.add_column(u'mentors_mentor', 'wants_support',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Mentor.wants_champion'
        db.add_column(u'mentors_mentor', 'wants_champion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Mentor.wants_lead'
        db.add_column(u'mentors_mentor', 'wants_lead',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Mentor.curtin_status'
        db.delete_column(u'mentors_mentor', 'curtin_status')
