...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mentor.curtin_id'
        db.add_column(u'mentors_mentor', 'curtin_id',
                      self.gf('django.db.models.fields.TextField')(max_length=10, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Mentor.curtin_id'
        db.delete_column(u'mentors_mentor', 'curtin_id')
