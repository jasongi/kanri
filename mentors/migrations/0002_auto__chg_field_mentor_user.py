...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mentor.user'
        db.alter_column(u'mentors_mentor', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.KanriUser'], unique=True))

    def backwards(self, orm):

        # Changing field 'Mentor.user'
        db.alter_column(u'mentors_mentor', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
