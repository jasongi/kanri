...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attendance.dojo'
        db.alter_column(u'attendance_attendance', 'dojo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.DojoSession']))

    def backwards(self, orm):

        # Changing field 'Attendance.dojo'
        db.alter_column(u'attendance_attendance', 'dojo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Dojo']))
