...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'attendance_attendance', (
            ...
            ('ninja', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ninjas.Ninja'])),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.DojoSession'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('added_by', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.KanriUser'], unique=True)),
        ))
