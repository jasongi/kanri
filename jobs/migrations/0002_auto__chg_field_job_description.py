...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'jobs_job', 'description', self.gf('django.db.models.fields.TextField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Job.description'
        db.alter_column(u'jobs_job', 'description', self.gf('django.db.models.fields.CharField')(max_length=1024))
