...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Job'
        db.create_table(u'planner_job', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('time', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'planner', ['Job'])

        # Adding model 'JobAllocation'
        db.create_table(u'planner_joballocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Job'])),
        ...
        db.send_create_signal(u'planner', ['JobAllocation'])


    def backwards(self, orm):
        # Deleting model 'Job'
        db.delete_table(u'planner_job')

        # Deleting model 'JobAllocation'
        db.delete_table(u'planner_joballocation')
    ...
    models = {
        ...
        u'planner.job': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'time': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        u'planner.joballocation': {
            'Meta': {'object_name': 'JobAllocation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['planner.Job']"}),
