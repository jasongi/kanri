...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'planner_shift', 'start',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(10, 4, 27, 101177)),
                      keep_default=False)

        # Adding field 'Shift.end'
        db.add_column(u'planner_shift', 'end',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(10, 4, 42, 357351)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shift.start'
        db.delete_column(u'planner_shift', 'start')

        # Deleting field 'Shift.end'
        db.delete_column(u'planner_shift', 'end')
